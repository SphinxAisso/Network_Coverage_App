...
import { ZsLoginModalComponent } from '../../../../../../main/webapp/app/shared/login/login.component';
...
describe('Component Tests', () => {
    ...
    describe('LoginComponent', () => {
        ...
        let comp: ZsLoginModalComponent;
        let fixture: ComponentFixture<ZsLoginModalComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ZsLoginModalComponent],
                providers : [
                    {
            ...
            .overrideTemplate(ZsLoginModalComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(ZsLoginModalComponent);
