...
import { ZsHealthCheckComponent } from '../../../../../../main/webapp/app/admin/health/health.component';
import { ZsHealthService } from '../../../../../../main/webapp/app/admin/health/health.service';

describe('Component Tests', () => {

    describe('ZsHealthCheckComponent', () => {

        let comp: ZsHealthCheckComponent;
        let fixture: ComponentFixture<ZsHealthCheckComponent>;
        let service: ZsHealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [CraTestModule],
                declarations: [ZsHealthCheckComponent],
                providers: [
                    ZsHealthService
                ]
            })
            .overrideTemplate(ZsHealthCheckComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(ZsHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(ZsHealthService);
        });
